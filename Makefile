...
CXXFLAGS      = -m64 -pipe -std=c++11 -O2 -D_REENTRANT -Wall -W -fPIC $(DEFINES)
...
SOURCES       = main.cpp \
		...
		Guerre.cpp \
		Logicos.cpp \
		matheux.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		NFederation.o \
		Democratie.o \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.hh Democratie.hh Federation.hh NFederation.hh Parti.hh Pays.hh Tyrannie.hh Labyrinthe.hh Guerre.h Logicos.h matheux.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp NFederation.cpp Democratie.cpp Federation.cpp Parti.cpp Pays.cpp Tyrannie.cpp Labyrinthe.cpp Guerre.cpp Logicos.cpp matheux.cpp $(DISTDIR)/
...
NFederation.o: NFederation.cpp NFederation.hh \
		Democratie.hh \
		Pays.hh \
		Parti.hh \
		Tyrannie.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o NFederation.o NFederation.cpp

Democratie.o: Democratie.cpp Democratie.hh \
		Pays.hh \
		Parti.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Democratie.o Democratie.cpp

Federation.o: Federation.cpp Federation.hh \
		Parti.hh \
		Democratie.hh \
		Pays.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Federation.o Federation.cpp

Parti.o: Parti.cpp Parti.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Parti.o Parti.cpp

Pays.o: Pays.cpp Pays.hh \
		Parti.hh
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Pays.o Pays.cpp

Tyrannie.o: Tyrannie.cpp Tyrannie.hh \
		Pays.hh \
		Parti.hh
...
Guerre.o: Guerre.cpp Guerre.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Guerre.o Guerre.cpp

Logicos.o: Logicos.cpp Logicos.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Logicos.o Logicos.cpp

matheux.o: matheux.cpp matheux.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o matheux.o matheux.cpp
